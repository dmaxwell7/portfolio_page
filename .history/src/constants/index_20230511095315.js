  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        ...
        Experience your dream metaverse world like never before with my web application. With just a VR headset, users can immerse themselves in a fully interactive and customizable virtual environment. Visit my portfolio to learn more about this innovative project and the technologies used to bring it to life.",
      tags: [
        {
          name: "nextjs",
          color: "blue-text-gradient",
