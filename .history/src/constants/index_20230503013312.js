import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "Proven ability to build and maintain strong client relationships, develop and implement personalized financial plans, and deliver exceptional service.",
        "Expertise in analyzing market trends, researching investment opportunities, and developing comprehensive financial plans that align with client goals and risk tolerance.",
        "Strong communication skills with the ability to clearly and concisely communicate complex financial information to clients, conduct financial seminars and workshops, and write detailed reports on investment opportunities.",
        "Up-to-date knowledge of the financial industry, including relevant licenses, certifications, and training. In-depth knowledge of specific areas of expertise, such as retirement planning, tax strategies, or estate planning.",
      ],
    },
    {
