  ...
  const projects = [
    {
      name: "Gym Page",
      description:
        "Introducing my fitness application, where users can select their preferred exercise categories and specific muscle groups. With over a thousand exercises, each with practical examples and detailed instructions, this app provides a comprehensive fitness experience.",
      tags: [
        {
          name: "react",
