  ...
  const projects = [
    {
      name: "Gym Page",
      description:
        "Introducing my fitness application, where users can select their preferred exercise categories and specific muscle groups. With over a thousand exercises, each with practical examples and detailed instructions, this app provides a comprehensive fitness experience. Visit my portfolio to learn more about this project and how it can help users achieve their fitness goals.",
      tags: [
        {
          name: "react",
