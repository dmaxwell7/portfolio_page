import {
  ...
  const projects = [
    ...
    },
    {
      name: "AI Summarizer",
      description:
        "A web article summarizer application utilizing OpenAI's GPT model. With this application, users can input lengthy article links to generate concise summaries. Check out my portfolio to learn more about this project and my other work!",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
