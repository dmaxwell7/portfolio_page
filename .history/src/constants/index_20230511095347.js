import {
  ...
  const projects = [
    ...
    },
    {
      name: "MetaVerse",
      description:
        "Experience your dream metaverse world like never before with my web application. With just a VR headset, users can immerse themselves in a fully interactive and customizable virtual environment.",
      tags: [
        {
          name: "nextjs",
          color: "blue-text-gradient",
